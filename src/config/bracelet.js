...
//校验(57) XX = 0x23^0+0x09^1+0x01^2+0x02^3+0x19^4+0x09^5+0x12^6+0x14^7+0x15^8+0x00^9+0x04^10;
//57的16进制为39
//base64转码后为: IwkBAhkJBQotJAM5 
//设置示例时间 15时30分 IwkBAhkJBQ8eJAMt 
//[0x23, 0x09, 0x01, 0x02, 0x19, 0x09, 0x05, 0xf, 0x1e, 0x24, 0x03, 0x39]
export const setLocalTime = [0x23, 0x09, 0x01, 0x02, 0x19, 0x09, 0x12, 0x14, 0x15, 0x00, 0x04, 0x23];
...
//校验(153) XX = 0x23^0+0x0b^1+0x02^2+0xF1^3+0x03^4+0x00^5+0x03^6+0x5d^7+0x7a^8+0x21^9+0x1a^10+0x00^11+0x00^12;
//153的16进制为99
//base64转码后为: IwsC8QMAA1wqU0UAAJk=
export const requestPacket = [0x23, 0x0b, 0x02, 0xF1, 0x03, 0x00, 0x03, 0x5d, 0x7a, 0x21, 0x1a, 0x00, 0x00, 0x37]
