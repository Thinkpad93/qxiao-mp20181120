...
//校验(57) XX = 0x23^0+0x09^1+0x01^2+0x02^3+0x19^4+0x09^5+0x17^6+0x16^7+0x40^8+0x00^9+0x02^10;
//57的16进制为39
//base64转码后为: IwkBAhkJBQotJAM5 
//设置示例时间 15时30分 IwkBAhkJBQ8eJAMt 
//[0x23, 0x09, 0x01, 0x02, 0x19, 0x09, 0x05, 0xf, 0x1e, 0x24, 0x03, 0x39]
export const setLocalTime = [0x23, 0x09, 0x01, 0x02, 0x19, 0x09, 0x17, 0x16, 0x40, 0x00, 0x02, 0x73];
